...
curl https://raw.githubusercontent.com/Rhyuu11/sc25/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/Rhyuu11/sc25/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
